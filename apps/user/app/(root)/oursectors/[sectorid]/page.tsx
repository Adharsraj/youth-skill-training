      ...
      {/* sec 1 */}
         <section className="my-8 px-0">
             {/* <div className="relative md:h-[280px] h-[180px] w-full">
               ...
               <div className="absolute inset-0 flex items-center justify-center text-white">
                 <div className="text-center">
                   <h2 className="lg:text-5xl md:text-4xl text-2xl font-bold">{sector.desc}</h2>
                 </div>
               </div>
             </div> */}
             {/* sec 2 */}
             <div className="flex flex-col-reverse md:flex-row items-center h-auto md:h-[300px] justify-center w-full px-0">
               ...
               <div className="w-full md:w-1/2">
                 <h2 className="lg:text-3xl text-xl text-center lg:text-left font-bold text-red-600">{sector.s2heading}</h2>
                 <p className="mt-4 md:text-md text-xs lg:text-lg text-center md:text-left">{sector.s2paragraph}</p>
               </div>
             </div>
           {/* {section.section === 3 && (
             <div className="flex flex-col md:flex-row items-center h-auto md:h-[380px] bg-primary-blue w-full px-0">
             ...
             <div className="flex flex-col md:flex-row items-center h-auto md:h-[280px] justify-center w-full px-0">
               <div className="w-full md:w-1/2">
                 <h2 className="lg:text-3xl font-bold md:text-xl text-lg text-red-600 lg:text-left text-center">{sector.s4heading}</h2>
                 <p className="mt-4 md:text-md lg:text-lg text-xs text-center lg:text-left">{sector.s4paragraph}</p>
               </div>
               <div className="relative w-full md:w-1/3 h-[200px] md:h-full ml-0 md:ml-8 mt-4 md:mt-0">
                 <Image
                   src={sector.s4Img}
